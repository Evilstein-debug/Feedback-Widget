    ...
    const features = [
        {
            ...
            description:
                "Built with Preact and Vite for a tiny bundle size. Adds zero lag to your website load time.",
            icon: <IconBolt />,
        },
        {
            title: "Universal Embed",
            description:
                "Works on any website—React, Vue, plain HTML, you name it. Just drop in the script tag.",
            icon: <IconWorld />,
        },
        {
        ...
        },
        {
            ...
            description: "Manage all your feedback, projects, and get code snippets in one centralized dashboard.",
